...
public:
    static std::vector<std::vector<T>> merge_chunks(const std::vector<std::vector<T>>& chunks1,
    ...
    static std::vector<std::vector<T>>
    transform_chunks(const std::vector<std::vector<T>>& chunks,
...
public:
    ...
    static std::vector<std::vector<T>> generate_random_chunks(size_t num_chunks, size_t chunk_size,
                                                              T min_val, T max_val) {
